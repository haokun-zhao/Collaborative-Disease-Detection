...
def parse_kgat_args():
    ...
    parser.add_argument('--data_name', nargs='?', default='eICU',
                        help='Choose a dataset from {yelp2018, last-fm, amazon-book, mimicIV, eICU}')
    ...
    parser.add_argument('--pretrain_model_path', nargs='?', default='trained_model/KGAT/mimicIV/embed-dim64_relation-dim64_random-walk_gcn_64-32-16_lr0.0001_pretrain2/model_epoch190.pth',#'trained_model/model.pth',
    ...
    parser.add_argument('--aggregation_type', type=str, default='gcn',#'bi-interaction',
    ...
    save_dir = 'trained_model/KGAT/{}/embed-dim{}_relation-dim{}_{}_{}_{}_lr{}_pretrain{}_seed{}/'.format(
        args.data_name, args.embed_dim, args.relation_dim, args.laplacian_type, args.aggregation_type,
        '-'.join([str(i) for i in eval(args.conv_dim_list)]), args.lr, args.use_pretrain, args.seed)
