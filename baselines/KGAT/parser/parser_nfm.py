...
def parse_nfm_args():
    ...
    parser.add_argument('--use_pretrain', type=int, default=2,
                        help='0: No pretrain, 1: Pretrain with the learned embeddings, 2: Pretrain with stored model.')
    parser.add_argument('--pretrain_embedding_dir', nargs='?', default='datasets/pretrain/',
                        help='Path of learned embeddings.')
    parser.add_argument('--pretrain_model_path', nargs='?', default='trained_model/NFM/mimicIV/nfm_embed-dim64_64-32-16_lr0.0001_pretrain0_seed42/model_epoch100.pth',
    ...
    parser.add_argument('--test_cores', type=int, default=1,
    ...
    save_dir = 'trained_model/NFM/{}/{}_embed-dim{}_{}_lr{}_pretrain{}_seed{}/'.format(
        args.data_name, args.model_type, args.embed_dim,
        '-'.join([str(i) for i in eval(args.hidden_dim_list)]), args.lr, args.use_pretrain, args.seed)
