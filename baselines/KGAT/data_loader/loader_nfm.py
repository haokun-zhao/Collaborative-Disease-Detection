...
class DataLoaderNFM(DataLoaderBase):
    ...
    def __init__(self, args, logging):
        ...
        # Use kg_final0.txt for MIMIC-style clinical graphs (same layout as KGAT mimicIV)
        if self.data_name in ('mimicIV', 'eICU'):
            kg_file = os.path.join(self.data_dir, "kg_final0.txt")
        else:
            kg_file = self.kg_file
